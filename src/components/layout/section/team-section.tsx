    ...
    return (
        <section className="py-12 md:py-32">
            <div className="mx-auto max-w-3xl px-8 lg:px-0">
                ...
                <div className="mt-6">
                    <h3 className="mb-6 text-lg font-medium">Senior Software Engineer</h3>
                ...
                <div className="mt-6">
                    <h3 className="mb-6 text-lg font-medium">Software Engineer</h3>
                    <div data-rounded="full" className="grid grid-cols-2 gap-4 border-t py-6 md:grid-cols-4">
                        {members.map((member, index) => (
                            <div key={index}>
                                <div className="bg-background size-20 rounded-full border p-0.5 shadow shadow-zinc-950/5">
                ...
                <div className="mt-6">
                    <h3 className="mb-6 text-lg font-medium">Junior Software Engineer</h3>
                    <div data-rounded="full" className="grid grid-cols-2 gap-4 border-t py-6 md:grid-cols-4">
                        {members.map((member, index) => (
                            <div key={index}>
                                <div className="bg-background size-20 rounded-full border p-0.5 shadow shadow-zinc-950/5">
